...
const Rail = () => {
  const [listItems, setListItems] = useState([{ number: '', quantity: '', length: '', width: '', thickness: '', volume: '', grade: '' }]);

  const handleAddItem = () => {
    setListItems([...listItems, { number: '', quantity: '', length: '', width: '', thickness: '', volume: '', grade: '' }]);
  };
